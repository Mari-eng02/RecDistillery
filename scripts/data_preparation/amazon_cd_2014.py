...
from recdistill.paths import AMAZONCD, dataset_directory, dataset_filepath

dataset_name = AMAZONCD

dataset = AmazonCDAndVinyl(version="2014")
...
kcore = UserItemIterativeKCore(cores=[10, 10])
