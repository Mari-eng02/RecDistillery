from datarec.datasets import AmazonDigitalMusic
# download dataset
...
from recdistill.paths import AMAZONDM, dataset_directory, dataset_filepath

dataset_name = AMAZONDM

dataset = AmazonDigitalMusic(version="2018")
