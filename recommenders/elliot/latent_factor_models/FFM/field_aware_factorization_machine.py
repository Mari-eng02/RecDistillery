...
from recommenders.elliot.local_samplers import pointwise_pos_neg_sampler as pws
from recommenders.elliot.base_recommender_model import BaseRecommenderModel
from recommenders.elliot.latent_factor_models.FFM.field_aware_factorization_machine_model import FieldAwareFactorizationMachineModel
from recommenders.elliot.recommender_utils_mixin import RecMixin
from recommenders.elliot.local_utils import store_recommendation
from recommenders.elliot.base_recommender_model import init_charger


class FFM(RecMixin, BaseRecommenderModel):
    r"""
    ...
    def __init__(self, data, config, params, *args, **kwargs):
        ...
        self._model = FieldAwareFactorizationMachineModel(self._num_users,
                                                          self._num_items,
                                                          self._factors,
                                                          self._l_w,
                                                          self._learning_rate,
