...
from recommenders.elliot.local_samplers import sparse_sampler as sp
...
from recommenders.elliot.neural.UserAutoRec.userautorec_model import UserAutoRecModel
