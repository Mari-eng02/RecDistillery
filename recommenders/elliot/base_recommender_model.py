...
from recommenders.elliot.local_utils import build_model_folder
...
from recommenders.elliot import local_logging as logging
from recommenders.elliot.early_stopping import EarlyStopping
...
def init_charger(init):
    ...
    def new_init(self, *args, **kwargs):
        ...
        try:
            from recommenders.elliot.evaluation.evaluator import Evaluator
        except ModuleNotFoundError:
            Evaluator = None
        self.evaluator = Evaluator(self._data, self._params) if Evaluator else None
