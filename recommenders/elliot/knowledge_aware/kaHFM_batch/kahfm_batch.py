...
from recommenders.elliot.local_samplers import custom_sampler as cs
...
from recommenders.elliot.knowledge_aware.kaHFM_batch.kahfm_batch_model import KaHFM_model
from recommenders.elliot.knowledge_aware.kaHFM_batch.tfidf_utils import TFIDF
...
class KaHFMBatch(RecMixin, BaseRecommenderModel):
    ...
    def __init__(self, data, config, params, *args, **kwargs):
        ...
        # self._factors = self._side.nfeatures
