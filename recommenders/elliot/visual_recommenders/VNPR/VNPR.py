...
from recommenders.elliot.visual_recommenders.VNPR import pairwise_pipeline_sampler_vnpr as ppsv
...
from recommenders.elliot.visual_recommenders.VNPR.VNPR_model import VNPRModel
