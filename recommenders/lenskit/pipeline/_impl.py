...
from recommenders.lenskit.data import Dataset
from recommenders.lenskit.diagnostics import PipelineError
...
if TYPE_CHECKING:
    from recommenders.lenskit.training import TrainingOptions
...
class Pipeline:
    ...
    def train(self, data: Dataset, options: TrainingOptions | None = None) -> None:
        ...
        """
        from recommenders.lenskit.training import Trainable, TrainingOptions  # lazy import
