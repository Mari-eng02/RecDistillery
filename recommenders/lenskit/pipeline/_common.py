...
from recommenders.lenskit.data import ID, ItemList, RecQuery
from recommenders.lenskit.pipeline.config import PipelineOptions
...
class RecPipelineBuilder:
    ...
    def __init__(self):
        from recommenders.lenskit.basic.candidates import TrainingItemsCandidateSelector
        from recommenders.lenskit.basic.topn import TopNRanker
    ...
    def ranker(
        ...
        *,
        ...
        with ``n=n``.
        """
        from recommenders.lenskit.basic.topn import TopNConfig, TopNRanker
    ...
    def build(self, name: str | None = None) -> Pipeline:
        ...
        """
        from recommenders.lenskit.basic.composite import FallbackScorer
        from recommenders.lenskit.basic.history import UserTrainingHistoryLookup
...
def topn_predict_builder(
    ...
    Args:
        ...
        options:
            The pipeline options to configure the base pipeline.
    """
    from recommenders.lenskit.basic import BiasScorer, FallbackScorer
    ...
    *,
    ...
    Args:
        ...
        name:
            The pipeline name.
    """
    from recommenders.lenskit.basic.bias import BiasScorer
