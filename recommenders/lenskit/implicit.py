...
from recommenders.lenskit.parallel.config import ensure_parallel_init, get_parallel_config
...
try:
    ...
    class _MissingImplicit(RecommenderBase):
        def __init__(self, *args, **kwargs):
            raise ImportError("The optional 'implicit' package is required to use this LensKit wrapper.")

    AlternatingLeastSquares = _MissingImplicit
    BayesianPersonalizedRanking = _MissingImplicit
