...
from recommenders.lenskit._accel import FunkSVDTrainer
from recommenders.lenskit.basic import BiasModel, Damping
...
from recommenders.lenskit.data.types import NPMatrix
