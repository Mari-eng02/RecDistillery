...
from recommenders.lenskit.util import Latch
...
def _lk_machine():
    from recommenders.lenskit.config import lenskit_config
...
class Task(BaseModel, extra="allow"):
    ...
    def save_to_file(self, path: PathLike[str], monitor: bool = True):
        ...
        if (
            ...
            from recommenders.lenskit.logging._monitor import get_monitor
